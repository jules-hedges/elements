...
When $\cat M$ is a monoidal category, an $\cat M$-actegory is defined abstractly as a pseudoalgebra of the pseudomonad $\cat M \times -$ on the 2-category of monoidal categories. However, we will give the definition explicitly and not use the theory of pseudomonads.
